...
<div id="topmenu">
  <ul>
    ...
    <li id="current"><?php echo $html->link('<span>Location map</span>', array('controller'=> 'contents','action'=>'location_map'),array('escape'=>false)); ?></li>
    <li><?php echo $html->link('<span>Reservation</span>', array('controller'=> 'contents','action'=>'reservation'),array('escape'=>false)); ?></li>
