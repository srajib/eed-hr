<div class="contents index">
	...
	<tr>
			<th width="35"><?php echo $this->Paginator->sort('id');?></th>
			<th width="244"><?php echo $this->Paginator->sort('title');?></th>
			<th width="248"><?php echo $this->Paginator->sort('slug');?></th>
			<th width="89"><?php echo $this->Paginator->sort('modified');?></th>
			<th width="138" class="actions"><?php __('Actions');?></th>
	</tr>
	<?php
	$i = 0;
