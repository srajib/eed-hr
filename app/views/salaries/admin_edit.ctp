...
<h2 align="center" style="width:500px;">Edit Employee Salary </h2>


<?php echo $this->Form->create('Employee',  array('url' => array('controller' => 'salaries', 'action' => 'admin_edit')));
	...
	<div>
	  ...
	  <fieldset class="ui-widget-content" style="width:550px;">
