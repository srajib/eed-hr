...
<?php echo $this->Form->create('EmployeeFine', array('url' => array('controller' => 'employees', 'action' => 'editfine'))); 
...
?>
	...
	<div class="input"> 
      <?php echo $this->Form->input('fines',array('label'=>'Fines'));  ?>   
	</div> 
	
	<div class="input"> 
      <?php 
	     echo $this->Form->input('date', array(
			'label' => 'Fine taken Date',
			'dateFormat' => 'DMY',
			'minYear' => date('Y') - 70,
			'maxYear' => date('Y') + 50 ));
	   ?>     
