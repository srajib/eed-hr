...
<body style="font-size:62.5%;">
  ...
  <?php echo $this->Form->input('employee_id');  ?>
    ...
    <div class="input"> 
      <?php echo $this->Form->input('present_address_Zilla',array('class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
    <div class="input"> 
      <?php echo $this->Form->input('present_address_upozilla',array('class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
    <div class="input"> 
      <?php echo $this->Form->input('present_address_post_code',array('class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
    ...
    <div class="input"> 
      <?php echo $this->Form->input('parmanent_address_zilla',array('class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
    <div class="input"> 
      <?php echo $this->Form->input('parmanent_address_upozilla',array('class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
    <div class="input"> 
      <?php echo $this->Form->input('parmanent_address_post_code',array('class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
...
<!--	
	...
	<div class="input"> 
	  ...
	  echo $this->Form->input('retirement_date', array(
	   ...
	   ?>   
        ...
        <fieldset id="edu_info">
            <legend>Educational Informations</legend>
            <?php
                for($i = 0; $i < (int)sizeof($Employee['EducationalQualification'], FALSE); $i++):
            ?>
                <h3><?php echo ($i+1); ?></h3>
                <div class="input"> 
                  <?php echo $this->Form->input('EducationalQualification.'.$i.'.name_of_degree',array('class'=>'ui-state-default ui-corner-all'));  ?>   
                </div>


                <div class="input"> 
                  <?php echo $this->Form->input('EducationalQualification.'.$i.'.name_of_institution',array('class'=>'ui-state-default ui-corner-all'));  ?>   
                </div>
                <div class="input"> 
                  <?php echo $this->Form->input('EducationalQualification.'.$i.'.board',array('class'=>'ui-state-default ui-corner-all'));  ?>   
                </div>



                <div class="input"> 
                  <?php echo $this->Form->input('EducationalQualification.'.$i.'.country',array('class'=>'ui-state-default ui-corner-all'));  ?>   
                </div>


                <div class="input"> 
                  <?php echo $this->Form->input('EducationalQualification.'.$i.'.year_of_passing',array('type'=>'text','class'=>'ui-state-default ui-corner-all'));  ?>   
                </div>

                <div class="input"> 
                  <?php echo $this->Form->input('EducationalQualification.'.$i.'.result',array('class'=>'ui-state-default ui-corner-all'));  ?>   
                </div>
            <?php   endfor; ?>
        </fieldset>
        
        <a id="add_inst">Add More Educational Information</a>
	...
	<div class="input"> 
	  ...
	  echo $this->Form->input('date_of_increament', array(
	   ...
	   ?>   
        ...
        <fieldset id="leave_info">
            <legend>Leave Informations</legend>
            <?php
                for($i = 0; $i < (int)sizeof($Employee['Leave'], FALSE); $i++):
            ?>
            <h3><?php echo ($i+1); ?></h3>
    <div class="input"> 
      <?php echo $this->Form->input('Leave.'.$i.'.leave_start',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
                
                
    <div class="input"> 
      <?php echo $this->Form->input('Leave.'.$i.'.leave_end',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
    <div class="input"> 
      <?php echo $this->Form->input('Leave.'.$i.'.leave_length_days',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
        
        
        
    <div class="input"> 
      <?php echo $this->Form->input('Leave.'.$i.'.nature_of_leave',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
            
	
    <div class="input"> 
      <?php echo $this->Form->input('Leave.'.$i.'.grounds',array('type'=>'text','class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
        
    <div class="input"> 
      <?php echo $this->Form->input('Leave.'.$i.'.sanction_order_number',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
	...
	<div class="input"> 
	  ...
	  echo $this->Form->input('Leave.'.$i.'.sanction_order_date', array(
			'class'=>'ui-state-default ui-corner-all',
			'dateFormat' => 'DMY',
			'minYear' => date('Y') - 70,
			'maxYear' => date('Y') ));
	   ?>   
        ...
        <a id="add_leave">Add More Leave Information</a>
        ...
        <fieldset id="srv_info">
            ...
            <h3><?php echo $i+1; ?></h3>
    <div class="input"> 
      <?php echo $this->Form->input('ServiceHistory.'.$i.'.join_date',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
                
                
    <div class="input"> 
      <?php echo $this->Form->input('ServiceHistory.'.$i.'.name_of_post',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
    <div class="input"> 
      <?php echo $this->Form->input('ServiceHistory.'.$i.'.name_of_cadre',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
	...
	<div class="input"> 
	  ...
	  echo $this->Form->input('ServiceHistory.'.$i.'.date_of_promotion', array(
			'class'=>'ui-state-default ui-corner-all',
			'dateFormat' => 'DMY',
			'minYear' => date('Y') - 70,
			'maxYear' => date('Y') ));
    ...
    <div class="input"> 
      <?php echo $this->Form->input('ServiceHistory.'.$i.'.nature_of_appointment',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
            
	
    <div class="input"> 
      <?php echo $this->Form->input('ServiceHistory.'.$i.'.scale_of_pay',array('type'=>'text','class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
        
    <div class="input"> 
      <?php echo $this->Form->input('ServiceHistory.'.$i.'.monthly_pay_date',array('class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
        
	
    <div class="input"> 
      <?php echo $this->Form->input('ServiceHistory.'.$i.'.other_monthly_pay',array('type'=>'text','class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
        
	
    <div class="input"> 
      <?php echo $this->Form->input('ServiceHistory.'.$i.'.remarks',array('type'=>'text','class'=>'ui-state-default ui-corner-all'));  ?>   
    </div>
        ...
        <a id="add_srv">Add More Service History</a>
...
<div class="clear" style="height:300px;"></div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var inst_count = parseInt('<?php echo (int)sizeof($Employee['EducationalQualification'], FALSE)-1; ?>');
            ...
            var leave_count =  parseInt('<?php echo (int)sizeof($Employee['Leave'], FALSE)-1; ?>');
            ...
            var srv_count =  parseInt('<?php echo (int)sizeof($Employee['ServiceHistory'], FALSE)-1; ?>');
