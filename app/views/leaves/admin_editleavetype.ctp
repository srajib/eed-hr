...
<?php echo $this->Form->create('LeaveType',  array('url' => array('controller' => 'leaves', 'action' => 'editleavetype')));
...
?>
  ...
  <legend> Leave Info</legend>
	 ...
	 <div class="input"> 
      <?php echo $this->Form->input('leave_type_name');  ?>
	</div> 

	 <div class="input"> 
      <?php echo $this->Form->input('leave_length_days');  ?>   
	</div> 
