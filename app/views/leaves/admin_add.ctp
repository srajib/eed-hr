...
<?php echo $this->Form->create('Leave'); ?>
  ...
  <div style="float:left;display:inline;">
     ...
     <div class="input" style="float:left;display:inline;"> 
      <?php echo $this->Form->input('application_date',array('label'=>'Application Date','type'=>'text','style'=>'width:100px;','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
    ...
    <div class="clear">&nbsp;</div>
	  ...
	  <?php    
            ...
            echo $this->Form->select('employee_id',$employees,array('label'=>'Employee','class'=>'ui-state-default ui-corner-all'));  ?>   
	  </div> 
	 
	 
	 <div class="input"> 
      <?php echo $this->Form->input('department', $departments,array('default'=>'1','label'=>'','class'=>'ui-state-default ui-corner-all'));  ?>
	</div> 

	 <div class="input"> 
      <?php echo $this->Form->input('designation',$designations,array('default'=>'1','label'=>'','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div> 
    ...
    <div class="input" style="float:left;display:inline;">
      <?php echo $this->Form->input('leave_start',array('label'=>'Leave Start Date','type'=>'text','style'=>'width:100px;','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
	...
	<div class="input" style="margin-left:-10px;float:left;display:inline;">
      <?php echo $this->Form->input('leave_end',array('label'=>'Leave End Date','type'=>'text','style'=>'width:80px;','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
	...
	<div class="input"> 
      <?php echo $this->Form->input('leave_length_days',array('label'=>'No. of Days','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
			 ...
			 $merchant_select = '1' ;
			  ...
			  echo $form->input('leave_type_id',
						array('label' => 'Leave Type',
						  'options' => $LeaveType,
						  'default' => $merchant_select,'class'=>'ui-state-default ui-corner-all ui-helper-hidden'));
	...
	<div style="float:left;display:inline;margin-left:40px;">
	 ...
	 <div class="input"> 
      ...
      <?php echo $this->Form->input('leave_reason',array('label'=>'Purpose of Leave','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>
	  
	 
	 <div class="input"> 
      <?php echo $this->Form->input('leave_period_contact',array('label'=>'Address & Contact Telephone # during Leave Period','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div> 
         
    <div class="input"> 
      <?php echo $this->Form->input('leave_recomendation',array('label'=>'Recomended by ( Section Head )','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>    
...
<!--        <style>
      ...
      echo $this->Form->checkbox('leave_chked_admin',array('label'=>'Checked by Substitues','type'=>'check','style'=>'<div>','class'=>'ui-state-default ui-corner-all'));  ?>   
	</div>  
     <div class="clear"></div>
	 ...
	 <div class="input" style="display:inline;"> 
       ...
       echo $this->Form->checkbox('leave_chked_md',array('label'=>'Checked by Section Head','type'=>'check','style'=>'<div>','class'=>'ui-state-default ui-corner-all'));  
