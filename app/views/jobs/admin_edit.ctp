...
<?php 	//debug($this->data);  ?>
<h2>Edit / Activate Job - [<?php echo $this->data['Job']['title']; ?>] </h2>

<div class="clear mt8">&nbsp;</div>
  <?php echo $this->Html->link(__('<< Back to job approval', true), array('controller' => 'jobs', 'action' => 'approval')); ?>
<div class="clear mt8">&nbsp;</div>
  
<div>&nbsp;</div>
<div class="jobs biginput" style="padding: 10px;">
<?php echo $this->Form->create('Job');?>

<div class="input select">
	<?php  
		echo $this->Form->input('id');
		echo $this->Form->input('JobDetail.id');
...
<div class="input radio">
	...
	<table width="560" border="0" cellpadding="0" cellspacing="0">
	  <tr>
		...
		<td width="202" valign="top"><div  style="padding: 5px;" id="district_selected">&nbsp;</div></td>
		</tr>
	</table>
	</div>
	...
	<table width="560" border="0" cellpadding="0" cellspacing="0">
	  <tr>
		...
		<td width="202" valign="top"><div  style="padding: 5px;" id="country_selected">&nbsp;</div></td>
		</tr>
	</table>
	</div>
...
<div class="input select autowidth">
  ...
  <table width="300"  border="0" cellpadding="0" cellspacing="0">
    ...
    <td width="207" valign="top">
		<div style="padding: 5px;" id="expes_selected"></div>
	</td>
  </tr>
</table>
  ...
  <label>Do you need the candidate to have experience in the following Business Areas/Industries?</label>
	  ...
	  <table width="570" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <td width="207" valign="top">
<div style="padding: 5px;" id="indus_selected"></div>		  </td>
		</tr>
	  </table>
</div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td align="center">
	  ...
	  <strong><?php echo $CompanyProfile['CompanyProfile']['company_name']; ?></strong>
	  <div><?php echo $CompanyProfile['CompanyProfile']['company_address_1']; ?></div>
	  <div><?php echo $CompanyProfile['CompanyProfile']['company_address_2']; ?></div>	</td>
  </tr>
  <tr>
    <td align="center"><strong>Business:</strong> <?php echo $CompanyProfile['CompanyProfile']['business_description']; ?></td>
  </tr>
  <tr>
    <td>
	  <strong>Contact Person:</strong> <?php echo $CompanyProfile['CompanyProfile']['contact_person']; ?>   
	  [ <?php echo $CompanyProfile['CompanyProfile']['contact_designation']; ?> ], 
	  <strong>Phone:</strong> <?php echo $CompanyProfile['CompanyProfile']['contact_phone']; ?>, 
	  <strong>Email:</strong> <?php echo $CompanyProfile['CompanyProfile']['contact_email']; ?> 
	</td>
  </tr>
  <tr>
    <td align="center">
	  <strong>Billing Address:</strong>
	  <div><?php echo $CompanyProfile['CompanyProfile']['billing_address_1']; ?> </div>
	  <div><?php echo $CompanyProfile['CompanyProfile']['billing_address_2']; ?> </div>
	</td>
  </tr>
  <tr>
    <td align="center"><strong>Website:</strong> <?php echo $CompanyProfile['CompanyProfile']['website']; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<div>&nbsp;</div>
<?php echo $this->Form->input('Job.active'); ?>
<div class="clear">&nbsp;</div>	
<?php echo $this->Form->input('JobDetail.remark'); ?>
<div>&nbsp;</div>
